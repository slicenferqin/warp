    ...
    .with_tooltip(move || {
        ui_builder
            .tool_tip(if is_sidebar_expanded {
                warp_i18n::tr("app-code-review-hide-file-navigation")
            } else {
                warp_i18n::tr("app-code-review-show-file-navigation")
            })
            .build()
            .finish()
    })
...
pub fn code_review_tooltip_text() -> String {
    warp_i18n::tr("app-code-review-view-changes")
}
...
pub fn get_discard_button_disabled_tooltip(git_operation_blocked: bool) -> String {
    if git_operation_blocked {
        warp_i18n::tr("app-code-review-discard-blocked-by-git-operation")
    } else {
        warp_i18n::tr("app-code-review-no-changes-to-discard")
    }
}
...
impl DiscardOperationType {
    pub fn title(&self) -> String {
        match self {
            DiscardOperationType::AllUncommittedChanges => {
                warp_i18n::tr("app-code-review-discard-uncommitted-title")
            }
            DiscardOperationType::FileUncommittedChanges => {
                warp_i18n::tr("app-code-review-discard-file-uncommitted-title")
            }
            DiscardOperationType::AllChangesAgainstBranch(_) => {
                warp_i18n::tr("app-code-review-discard-all-title")
            }
            DiscardOperationType::FileChangesAgainstBranch(_) => {
                warp_i18n::tr("app-code-review-discard-file-title")
            }
        }
    }
    ...
    pub fn description(&self) -> Option<String> {
        match self {
            DiscardOperationType::AllUncommittedChanges => Some(warp_i18n::tr(
                "app-code-review-discard-uncommitted-description",
            )),
            DiscardOperationType::FileUncommittedChanges => Some(warp_i18n::tr(
                "app-code-review-discard-file-uncommitted-description",
            )),
            DiscardOperationType::AllChangesAgainstBranch(None) => {
                Some(warp_i18n::tr("app-code-review-discard-all-description"))
            }
            DiscardOperationType::FileChangesAgainstBranch(None) => Some(warp_i18n::tr(
                "app-code-review-discard-file-main-description",
            )),
            ...
            DiscardOperationType::FileChangesAgainstBranch(Some(branch)) => {
                Some(warp_i18n::tr_with_args(
                    "app-code-review-discard-file-branch-description",
...
impl CodeReviewView {
    ...
    pub fn new(
        ...
        let maximize_button = ctx.add_typed_action_view(move |_| {
            ...
            let (icon, tooltip_text) = (Icon::Maximize, warp_i18n::tr("app-code-review-maximize"));
        ...
        let file_nav_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new("", NakedTheme)
                ...
                .with_tooltip(warp_i18n::tr("app-code-review-show-file-navigation"))
        ...
        let undo_action_button = ctx.add_typed_action_view(move |ctx| {
            ...
            let mut action_button =
                ActionButton::new(warp_i18n::tr("app-code-review-undo"), NakedTheme)
                    .with_size(ButtonSize::Small)
                    .on_click(move |ctx| {
        ...
        let discard_confirm_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                warp_i18n::tr("app-code-review-discard-changes"),
                DangerPrimaryTheme,
            )
        ...
        let init_project_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(
                warp_i18n::tr("app-code-review-initialize-codebase"),
                NakedTheme,
            )
            .with_size(ButtonSize::Small)
            .with_tooltip(warp_i18n::tr("app-code-review-initialize-codebase-tooltip"))
        ...
        let open_repository_button = ctx.add_typed_action_view(|_ctx| {
            ActionButton::new(warp_i18n::tr("app-code-review-open-repository"), NakedTheme)
                .with_size(ButtonSize::Small)
                .with_tooltip(warp_i18n::tr("app-code-review-open-repository-tooltip"))
                .with_tooltip_alignment(TooltipAlignment::Center)
    ...
    fn update_maximize_button(&mut self, ctx: &mut ViewContext<Self>) {
        ...
        let (icon, tooltip) = if is_maximized {
            (Icon::Minimize, warp_i18n::tr("app-code-review-restore"))
        } else {
            (Icon::Maximize, warp_i18n::tr("app-code-review-maximize"))
        };
        ...
        for file in files {
            ...
            let open_in_tab_button = ctx.add_typed_action_view(move |_ctx| {
                ActionButton::new("", NakedTheme)
                    ...
                    .with_size(ButtonSize::InlineActionHeader)
                    .with_tooltip(warp_i18n::tr("app-code-review-open-file"))
                    .on_click(move |ctx| {
            ...
            let add_context_button = ctx.add_typed_action_view(move |_ctx| {
                ActionButton::new("", NakedTheme)
                    ...
                    .with_size(ButtonSize::InlineActionHeader)
                    .with_tooltip(warp_i18n::tr("app-code-review-add-file-diff-context"))
                    .on_click(move |ctx| {
            ...
            let copy_path_button = ctx.add_typed_action_view(move |_ctx| {
                ActionButton::new("", NakedTheme)
                    .with_icon(Icon::Copy)
                    .with_size(ButtonSize::InlineActionHeader)
                    .with_tooltip(warp_i18n::tr("app-code-review-copy-file-path"))
                    .on_click(move |ctx| {
    ...
    fn render_placeholder_header(appearance: &Appearance) -> Box<dyn Element> {
        ...
        let header_text = warp_i18n::tr("app-code-review-loading-open-changes");
    ...
    fn render_error_state(&self, error: &str, appearance: &Appearance) -> Box<dyn Element> {
        ...
        let main_column = Flex::column()
            ...
            .with_child(
                Text::new(
                    warp_i18n::tr("app-code-review-error-loading-diffs"),
                    appearance.ui_font_family(),
                ...
                Container::new(
                    appearance
                        ...
                        .with_text_and_icon_label(TextAndIcon::new(
                            ...
                            format!(" {}", warp_i18n::tr("common-retry")),
    ...
    fn render_no_repo_found_state_with_buttons(
        ...
        let main_column = Flex::column()
            ...
            .with_child(
                Text::new(
                    warp_i18n::tr("app-code-review-cannot-detect-diffs-folder"),
                    appearance.ui_font_family(),
                    appearance.ui_font_size() + 2.,
                )
                .with_style(Properties::default().weight(Weight::Semibold))
    ...
    pub fn render_remote_state(
        ...
        Self::render_no_repo_found_state(
            appearance,
            warp_i18n::tr("app-code-review-local-workspaces-only"),
            open_repo_button,
        )
    }
    ...
    pub fn render_wsl_state(
        ...
        Self::render_no_repo_found_state(
            appearance,
            warp_i18n::tr("app-code-review-wsl-unavailable"),
            open_repo_button,
        )
    }
    ...
    pub fn render_not_repo_state(
        ...
        Self::render_no_repo_found_state(
            appearance,
            warp_i18n::tr("app-code-review-git-repositories-only"),
            open_repo_button,
        )
    }
    ...
    fn render_no_changes_state(
        ...
        let mut zero_state_column = Flex::column()
            ...
            .with_child(
                Text::new(
                    warp_i18n::tr("app-code-review-no-open-changes"),
                    appearance.ui_font_family(),
                    16.,
                )
                .with_style(Properties::default().weight(Weight::Semibold))
            ...
            .with_child(
                Container::new(
                    Text::new(
                        warp_i18n::tr("app-code-review-no-open-changes-description"),
                        appearance.ui_font_family(),
                        14.,
                    )
                            ...
                            Container::new(
                                Text::new(
                                    warp_i18n::tr_with_args(
                                        "app-code-review-repo-initialized-with-file",
                                        &[("file_name", file_name)],
                                    ),
                                    appearance.ui_font_family(),
                                    12.,
    ...
    pub fn handle_review_submission_result(
        ...
        match result {
            ReviewSubmissionResult::Success {
                ...
                ToastStack::handle(ctx).update(ctx, |stack, ctx| {
                    let toast = DismissibleToast::default(
                        warp_i18n::tr("app-code-review-comments-sent-to-agent").into(),
                    );
            ...
            ReviewSubmissionResult::Error => {
                ...
                let error_message = warp_i18n::tr("app-code-review-comments-send-failed");
    ...
    fn render_file_header(
        ...
        left_section.add_child(if let Some(editor_state) = &file.editor_state {
            if editor_state.has_unsaved_changes(app) {
                ...
                let tooltip_text = warp_i18n::tr_with_args(
                    "app-code-review-unsaved-file-tooltip",
                    &[("save_shortcut", save_shortcut.as_str())],
                );
    ...
    fn render_file_content(&self, file: &FileState, appearance: &Appearance) -> Box<dyn Element> {
        ...
        if diff_size == DiffSize::Unrenderable {
            return Self::styled_file_content_container(
                Text::new(
                    warp_i18n::tr("app-code-review-diff-too-large"),
        ...
        if file.file_diff.is_binary {
            Self::styled_file_content_container(
                Text::new(
                    warp_i18n::tr("app-code-review-binary-file-no-diff"),
                    appearance.monospace_font_family(),
                    appearance.monospace_font_size(),
                )
                .with_color(theme.main_text_color(theme.background()).into())
            ...
            Self::styled_file_content_container(
                Text::new(
                    warp_i18n::tr("app-code-review-file-renamed-no-changes"),
                    appearance.monospace_font_family(),
                    appearance.monospace_font_size(),
                )
                .with_color(theme.main_text_color(theme.background()).into())
            ...
            Self::styled_file_content_container(
                Text::new(
                    warp_i18n::tr("app-code-review-new-empty-file"),
                    appearance.monospace_font_family(),
                    appearance.monospace_font_size(),
                )
                .with_color(theme.main_text_color(theme.background()).into())
    ...
    fn render_file_row(&self, app: &AppContext) -> Box<dyn Element> {
        ...
        if self.discard_dialog_state.discard_file_paths.is_empty() {
            return Text::new(
                warp_i18n::tr("app-code-review-no-file-selected"),
                appearance.ui_font_family(),
                appearance.ui_font_size(),
            )
            .with_color(
        ...
        let CodeReviewViewState::Loaded(loaded) = self.state() else {
            return Text::new(
                warp_i18n::tr("app-code-review-no-files-to-discard"),
                appearance.ui_font_family(),
                appearance.ui_font_size(),
            )
            .with_color(
            ...
            let stash_checkbox = Container::new(
                appearance
                    ...
                    .with_label(
                        appearance
                            .ui_builder()
                            .span(warp_i18n::tr("app-code-review-stash-changes"))
                            .with_style(UiComponentStyles {
        ...
        match event {
            ...
            CodeEditorEvent::DiffReverted => {
                ...
                crate::workspace::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::default(warp_i18n::tr(
                        "app-code-review-diff-removed",
                    ))
    ...
    fn insert_selection_as_context(
        ...
        if let Some(terminal_view) = self.terminal_view.as_ref().and_then(|tv| tv.upgrade(ctx)) {
            ...
            if is_long_running {
                ...
                crate::workspace::ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = crate::view_components::DismissibleToast::default(warp_i18n::tr(
                        "app-code-review-cannot-attach-terminal-running",
                    ))
                    .with_object_id(toast_id);
                    toast_stack.add_ephemeral_toast(toast, self.window_id, ctx);
                });
    ...
    fn insert_diff_as_context(&mut self, scope: DiffSetScope, ctx: &mut ViewContext<Self>) {
            ...
            .and_then(|view| view.upgrade(ctx))
        {
            ...
            if !is_input_box_visible {
                ...
                ToastStack::handle(ctx).update(ctx, |toast_stack, ctx| {
                    let toast = DismissibleToast::default(warp_i18n::tr(
                        "app-code-review-cannot-attach-input-unavailable",
                    ))
                    .with_object_id(toast_id);
                    toast_stack.add_ephemeral_toast(toast, self.window_id, ctx);
                });
        ...
        match mode {
            PrimaryGitActionMode::Commit => {
                ...
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    button.set_label(warp_i18n::tr("app-code-review-commit"), ctx);
                    button.set_icon(Some(Icon::GitCommit), ctx);
                    button.set_disabled(disabled, ctx);
                    button.set_tooltip(
                        disabled.then_some(warp_i18n::tr("app-code-review-no-changes-to-commit")),
                        ctx,
                    );
                    button.set_on_click(
                ...
                self.git_operations_chevron.update(ctx, |button, ctx| {
                    ...
                    button.set_tooltip(
                        disabled
                            .then_some(warp_i18n::tr("app-code-review-no-git-actions-available")),
                        ctx,
                    );
                });
            }
            PrimaryGitActionMode::Push => {
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    button.set_label(warp_i18n::tr("app-code-review-push"), ctx);
            ...
            PrimaryGitActionMode::CreatePr => {
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    button.set_label(warp_i18n::tr("app-code-review-create-pr"), ctx);
            ...
            PrimaryGitActionMode::ViewPr => {
                ...
                if let Some(pr_info) = pr_info {
                    ...
                    let label = warp_i18n::tr_with_args(
                        "app-code-review-pr-number",
            ...
            PrimaryGitActionMode::Publish => {
                self.git_primary_action_button.update(ctx, |button, ctx| {
                    button.set_label(warp_i18n::tr("app-code-review-publish"), ctx);
    ...
    fn commit_menu_item(disabled: bool) -> MenuItem<CodeReviewAction> {
        MenuItemFields::new(warp_i18n::tr("app-code-review-commit"))
            .with_icon(Icon::GitCommit)
    ...
    fn push_or_publish_menu_item(has_upstream: bool, disabled: bool) -> MenuItem<CodeReviewAction> {
        if has_upstream {
            MenuItemFields::new(warp_i18n::tr("app-code-review-push"))
                .with_icon(Icon::ArrowUp)
                .with_on_select_action(CodeReviewAction::OpenPushDialog)
                .with_disabled(disabled)
                .into_item()
        } else {
            MenuItemFields::new(warp_i18n::tr("app-code-review-publish"))
    ...
    fn pr_menu_item(&self, app: &AppContext) -> MenuItem<CodeReviewAction> {
        ...
        if let Some(pr_info) = diff_state.pr_info().cloned() {
            ...
            MenuItemFields::new(warp_i18n::tr_with_args(
                "app-code-review-pr-number",
                &[("number", number.as_str())],
            ))
            ...
            let has_upstream = diff_state.upstream_ref().is_some();
            let upstream_differs_from_main = diff_state.upstream_differs_from_main();
            MenuItemFields::new(warp_i18n::tr("app-code-review-create-pr"))
                .with_icon(Icon::Github)
    ...
    fn header_menu_items_legacy(
        ...
        if FeatureFlag::DiffSetAsContext.is_enabled() && has_changes {
            items.push(
                MenuItemFields::new(warp_i18n::tr("app-code-review-add-diff-set-context"))
                    .with_icon(Icon::Paperclip)
        ...
        let (comment_label, comment_icon) = if self.get_existing_diffset_comment(ctx).is_some() {
            (
                warp_i18n::tr("app-code-review-show-saved-comment"),
                Icon::MessageText,
            )
        } else {
            (
                warp_i18n::tr("app-code-review-add-comment"),
    ...
    fn header_menu_items_new(
        ...
        if FeatureFlag::DiscardPerFileAndAllChanges.is_enabled() && has_changes {
            items.push(
                MenuItemFields::new(warp_i18n::tr("app-code-review-discard-all"))
                    .with_icon(Icon::ReverseLeft)
...
impl BackingView for CodeReviewView {
    ...
    fn render_header_content(
        ...
        view::HeaderContent::simple(warp_i18n::tr("app-code-review-reviewing-code-changes"))
    }
