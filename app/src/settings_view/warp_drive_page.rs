...
impl SettingsWidget for WarpDriveHeaderWidget {
    ...
    fn render(
        ...
        let message = Container::new(
            Text::new_inline(
                warp_i18n::tr("settings-warp-drive-sign-up-message"),
        ...
        let button = Container::new(
            ui_builder
                ...
                .with_text_label(warp_i18n::tr("settings-warp-drive-sign-up"))
                .build()
...
impl SettingsWidget for WarpDriveToggleWidget {
    ...
    fn render(
        ...
        render_body_item::<WarpDriveSettingsPageAction>(
            warp_i18n::tr("settings-warp-drive-title"),
            Some(AdditionalInfo {
            ...
            appearance
                ...
                .finish(),
            Some(warp_i18n::tr("settings-warp-drive-description")),
        )
    }
}
