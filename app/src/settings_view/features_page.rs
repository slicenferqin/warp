...
fn block_maximum_rows_description() -> String {
    if ChannelState::enable_debug_features() {
        warp_i18n::tr("settings-features-session-block-limit-description-debug")
    } else {
        warp_i18n::tr("settings-features-session-block-limit-description-release")
    }
}
...
impl FeaturesPageView {
    ...
    fn build_page(ctx: &mut ViewContext<Self>) -> PageType<Self> {
        ...
        let categories = vec![
            ...
            Category::new(
                "settings-features-category-text-editing",
                text_editing_widgets,
            ),
            Category::new("settings-features-category-terminal-input", editor_widgets),
        ...
        Flex::row()
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            warp_i18n::tr("settings-features-notifications-command-longer-than"),
                            appearance.ui_font_family(),
                            font_size,
                        )
            ...
            .with_child(
                Container::new(
                    Align::new(
                        Text::new_inline(
                            warp_i18n::tr("settings-features-notifications-seconds-to-complete"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
...
impl SettingsWidget for NativeRedirectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-open-links-desktop"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(warp_i18n::tr(
                    "settings-features-general-open-links-desktop-tooltip",
                )),
            }),
...
impl SettingsWidget for SessionRestorationWidget {
    ...
    fn render(
        ...
        let labeled_switch = render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-restore-session"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
        ...
        if app.is_wayland() {
            let message = Text::new_inline(
                format!(
                    "{} ",
                    warp_i18n::tr("settings-features-general-wayland-restore-warning")
                ),
                appearance.ui_font_family(),
                CONTENT_FONT_SIZE,
            )
...
impl SettingsWidget for SnackbarHeaderWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-show-sticky-command-header"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinkTooltipWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-show-link-tooltip"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWarningModalWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-show-quit-warning"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for LoginItemWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        #[cfg(target_os = "macos")]
        let label = warp_i18n::tr("settings-features-general-start-at-login-macos");
        #[cfg(not(target_os = "macos"))]
        let label = warp_i18n::tr("settings-features-general-start-at-login");
        render_body_item::<FeaturesPageAction>(
            label,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for QuitWhenAllWindowsClosedWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-quit-when-all-windows-closed"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ShowChangelogWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-show-changelog-after-updates"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseScrollMultiplierWidget {
    ...
    fn render(
            ...
            .with_children([
                ...
                if view.valid_mouse_scroll_multiplier {
                    ...
                    appearance
                        .ui_builder()
                        .wrappable_text(
                            warp_i18n::tr("settings-features-general-mouse-scroll-allowed-values"),
                            true,
                        )
                        .with_style(UiComponentStyles {
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-general-mouse-scroll-lines"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(warp_i18n::tr(
                    "settings-features-general-mouse-scroll-tooltip",
                )),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DefaultTerminalWidget {
    ...
    fn render(
        ...
        if default_terminal.is_warp_default() {
            ui_builder
                .wrappable_text(
                    warp_i18n::tr("settings-features-general-warp-default-terminal"),
                    true,
                )
                .with_style(UiComponentStyles {
            ...
            ui_builder
                .link(
                    warp_i18n::tr("settings-features-general-make-warp-default-terminal"),
                    None,
                    Some(Box::new(|ctx| {
...
impl SettingsWidget for BlockLimitWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-session-max-rows"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SSHWrapperWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-session-ssh-wrapper"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
                ...
                secondary_text: if view.ssh_wrapper_toggled {
                    Some(warp_i18n::tr(
                        "settings-features-session-ssh-wrapper-new-sessions",
                    ))
                } else {
                    None
                },
...
impl SettingsWidget for DesktopNotificationsWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-notifications-desktop"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
            ...
            let toggles = vec![
                view.render_notification_toggle(
                    session_settings
                        .notifications
                        .is_agent_task_completed_enabled,
                    warp_i18n::tr("settings-features-notifications-agent-completed"),
                ...
                view.render_notification_toggle(
                    ...
                    warp_i18n::tr("settings-features-notifications-needs-attention"),
                ...
                #[cfg(target_os = "macos")]
                {
                    view.render_notification_toggle(
                        ...
                        warp_i18n::tr("settings-features-notifications-play-sounds"),
        ...
        if FeatureFlag::HOANotifications.is_enabled() {
            ...
            column.add_child(render_body_item::<FeaturesPageAction>(
                warp_i18n::tr("settings-features-notifications-in-app-agent"),
                None,
            ...
            if show_agent_notifications {
                ...
                let toast_duration_row = Flex::row()
                    ...
                    .with_child(
                        Text::new_inline(
                            warp_i18n::tr("settings-features-notifications-toast-visible-for"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
                    ...
                    .with_child(
                        Text::new_inline(
                            warp_i18n::tr("settings-features-notifications-seconds"),
                            appearance.ui_font_family(),
                            font_size,
                        )
                        .with_color(font_color.into())
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    warp_i18n::tr("settings-features-startup-shell-title"),
    ...
    fn render(
        ...
        Flex::column()
            .with_children([
                render_sub_sub_header(
                    appearance,
                    warp_i18n::tr("settings-features-working-dir-title"),
                    Some(LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ConfirmCloseSharedSessionWidget {
    ...
    fn render(
        ...
        let session_settings = SessionSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-session-confirm-close-shared"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutocompleteSymbolsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-autocomplete-symbols"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for ErrorUnderliningWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-error-underlining"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for SyntaxHighlightingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-syntax-highlighting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CompletionsMenuWhileTypingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-completions-while-typing"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CommandCorrectionsWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-command-corrections"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AliasExpansionWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-alias-expansion"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MiddleClickPasteWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-middle-click-paste"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for VimModeWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-vim-mode"),
            None,
            LocalOnlyIconState::for_setting(
        ...
        if vim_mode_enabled {
            ...
            let clipboard_setting = view.render_setting_subgroup_item(
                ...
                clipboard_switch,
                warp_i18n::tr("settings-features-text-vim-system-clipboard"),
            );
            ...
            let status_bar_setting = view.render_setting_subgroup_item(
                ...
                status_bar_switch,
                warp_i18n::tr("settings-features-text-vim-status-bar"),
            );
...
impl SettingsWidget for AutosuggestionKeybindingHintWidget {
    ...
    fn render(
        ...
        column.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-autosuggestion-keybinding-hint"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AutosuggestionIgnoreButtonWidget {
    ...
    fn render(
        ...
        let show_autosuggestion_ignore_button = *app_editor_settings
            ...
            .value();
        column.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-text-autosuggestion-ignore-button"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for MouseReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-mouse-reporting"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ScrollReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-scroll-reporting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for FocusReportingWidget {
    ...
    fn render(
        ...
        let ui_builder = appearance.ui_builder();
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-focus-reporting"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for AudibleBellWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-audible-bell"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SmartSelectWidget {
    fn render_word_char_config(
        ...
        Flex::column()
            .with_child(
                ui_builder
                    .label(warp_i18n::tr("settings-features-terminal-word-characters"))
                    .with_style(UiComponentStyles {
                        margin: Some(Coords {
                            top: 10.0,
                            bottom: 5.0,
...
impl SettingsWidget for SmartSelectWidget {
    ...
    fn render(
        ...
        let mut column = Flex::column();
        column.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-smart-selection"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for ShowTerminalZeroStateBlockWidget {
    ...
    fn render(
        ...
        let terminal_settings = TerminalSettings::as_ref(app);
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-show-help-block"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for CopyOnSelectWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-terminal-copy-on-select"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for NewTabPlacementWidget {
    ...
    fn render(
        ...
        render_dropdown_item(
            appearance,
            &warp_i18n::tr("settings-features-terminal-new-tab-placement"),
            None,
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for DefaultSessionModeWidget {
    ...
    fn render(
        ...
        let label = render_dropdown_item_label(
            warp_i18n::tr("settings-features-terminal-default-session-mode"),
            None,
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for WorkflowsInCommandSearch {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-workflows-command-search"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: Some(FeaturesPageAction::OpenUrl(
...
impl SettingsWidget for LinuxSelectionClipboardWidget {
    ...
    fn render(
        ...
        render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-system-linux-selection-clipboard"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(warp_i18n::tr(
                    "settings-features-system-linux-selection-clipboard-tooltip",
                )),
            }),
            LocalOnlyIconState::for_setting(
...
impl SettingsWidget for GPUWidget {
    ...
    fn render(
        ...
        let mut col = Flex::column().with_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-system-integrated-gpu"),
            None,
            LocalOnlyIconState::for_setting(
            ...
            col.add_child(
                Container::new(
                    appearance
                        .ui_builder()
                        .wrappable_text(
                            warp_i18n::tr("settings-features-system-new-windows-change"),
                            true,
                        )
                        .with_style(UiComponentStyles {
...
impl SettingsWidget for WindowSystemWidget {
    ...
    fn render(
        ...
        children.add_child(render_body_item::<FeaturesPageAction>(
            warp_i18n::tr("settings-features-system-wayland-window-management"),
            Some(AdditionalInfo {
                mouse_state: self.additional_info_link.clone(),
                on_click_action: None,
                secondary_text: None,
                tooltip_override_text: Some(warp_i18n::tr(
                    "settings-features-system-wayland-tooltip",
                )),
            }),
            LocalOnlyIconState::for_setting(
        ...
        let mut secondary_text = warp_i18n::tr("settings-features-system-wayland-description");
        if view.force_x11_changed {
            secondary_text.push_str("\n\n");
            secondary_text.push_str(&warp_i18n::tr(
                "settings-features-system-restart-for-changes",
            ));
        }
...
impl SettingsWidget for GraphicsBackendWidget {
    ...
    fn render(
        ...
        let dropdown = render_dropdown_item(
            appearance,
            &warp_i18n::tr("settings-features-system-preferred-graphics-backend"),
            None,
            None,
            LocalOnlyIconState::for_setting(
            ...
            col.add_child(
                appearance
                    ...
                    .wrappable_text(
                        format!(
                            "{} {}",
                            warp_i18n::tr("settings-features-system-current-backend-prefix"),
                            backend.to_label()
                        ),
                        true,
                    )
