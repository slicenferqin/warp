...
use crate::{
    ...
    settings::{AISettings, LanguageSettings, PrivacySettings},
...
impl PrivacyPageView {
    ...
    pub fn new(ctx: &mut ViewContext<PrivacyPageView>) -> Self {
        ...
        let add_regex_modal_view = ctx.add_typed_action_view(|ctx| {
            Modal::new(
                Some(warp_i18n::tr("settings-privacy-add-regex-pattern-title")),
                add_regex_body,
                ctx,
            )
        ...
        let secret_display_dropdown = ctx.add_typed_action_view(|ctx| {
            ...
            dropdown.set_items(Self::secret_display_mode_dropdown_items(), ctx);
            dropdown
        });
    ...
    fn refresh_localized_text(&mut self, ctx: &mut ViewContext<Self>) {
        self.add_regex_modal_state.set_title(
            Some(warp_i18n::tr("settings-privacy-add-regex-pattern-title")),
            ctx,
        );
        self.update_secret_display_dropdown(ctx);
    }

    fn secret_display_mode_dropdown_items() -> Vec<DropdownItem<PrivacyPageAction>> {
        SecretDisplayMode::all_modes()
            .iter()
            .map(|mode| {
                DropdownItem::new(
                    Self::secret_display_mode_label(*mode),
    ...
    fn secret_display_mode_label(mode: SecretDisplayMode) -> String {
        match mode {
            SecretDisplayMode::Asterisks => {
                warp_i18n::tr("settings-privacy-secret-display-mode-asterisks")
            }
            SecretDisplayMode::Strikethrough => {
                warp_i18n::tr("settings-privacy-secret-display-mode-strikethrough")
            }
            SecretDisplayMode::AlwaysShow => {
                warp_i18n::tr("settings-privacy-secret-display-mode-always-show")
            }
        }
    }
...
impl SecretRedactionWidget {
    ...
    fn render_tab_bar(
        ...
        let personal_tab = self.render_tab(
            warp_i18n::tr("settings-privacy-personal-tab"),
            personal_count,
        ...
        let enterprise_tab = self.render_tab(
            warp_i18n::tr("settings-privacy-enterprise-tab"),
            enterprise_count,
        ...
        if is_enterprise_tab_active {
            ...
            row.add_child(self.render_info(
                warp_i18n::tr("settings-privacy-enterprise-redaction-read-only"),
                appearance,
            ));
        }
    ...
    fn render_enterprise_content(
        ...
        if enterprise_regex_list.is_empty() {
            return ui_builder
                .paragraph(warp_i18n::tr("settings-privacy-enterprise-regexes-empty"))
                .with_style(UiComponentStyles {
                    font_color: Some(description_text_color),
                    ..Default::default()
                })
                ...
                Container::new(
                    Flex::row()
                        ...
                        .with_child(self.render_section_title(
                            warp_i18n::tr("settings-privacy-recommended-title"),
                            appearance,
                        ))
                        .with_child(
                            Container::new(
                                ui_builder
                                    ...
                                    .with_text_and_icon_label(Self::add_button(
                                        warp_i18n::tr("settings-privacy-add-all"),
                                        appearance,
                                    ))
...
impl SettingsWidget for SecretRedactionWidget {
    ...
    fn search_terms(&self) -> &str {
        "secret redaction safe mode hide 敏感信息 遮盖 正则 隐藏"
    }
    ...
    fn render(
            ...
            Flex::row()
                .with_child(
                    Shrinkable::new(
                        ...
                        render_sub_header(
                            appearance,
                            warp_i18n::tr("settings-privacy-secret-redaction-title"),
                ...
                .with_child(
                    Container::new({
                        if is_enterprise_enabled {
                            self.render_info(
                                warp_i18n::tr("settings-privacy-enabled-by-organization"),
                                appearance,
                            )
                        } else {
                            ui_builder
            ...
            .with_child(
                ui_builder
                    .paragraph(warp_i18n::tr(
                        "settings-privacy-secret-redaction-description",
                    ))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
        ...
        if *safe_mode_settings.safe_mode_enabled {
            ...
            let label_with_icon = super::settings_page::render_dropdown_item_label(
                warp_i18n::tr("settings-privacy-secret-display-mode-title"),
                None,
                ...
                Flex::row()
                    ...
                    .with_child(
                        Expanded::new(
                            ...
                            Flex::column()
                                .with_child(self.render_section_title(
                                    warp_i18n::tr("settings-privacy-custom-secret-redaction-title"),
                                    appearance,
                                ))
                                .with_child(self.render_description(
                                    warp_i18n::tr(
                                        "settings-privacy-custom-secret-redaction-description",
                                    ),
                                    appearance,
                    ...
                    .with_child(
                        ui_builder
                            ...
                            .with_text_and_icon_label(Self::add_button(
                                warp_i18n::tr("settings-privacy-add-regex"),
                                appearance,
                            ))
                            .with_style(Self::add_button_style())
                            .build()
...
impl AppAnalyticsWidget {
    fn render_zero_data_retention_badge(&self, appearance: &Appearance) -> Box<dyn Element> {
        ...
        Hoverable::new(self.zdr_badge_mouse_state.clone(), move |mouse_state| {
            ...
            if is_hovered {
                let tooltip = ui_builder.tool_tip(warp_i18n::tr("settings-privacy-zdr-tooltip"));
...
impl SettingsWidget for AppAnalyticsWidget {
    ...
    fn search_terms(&self) -> &str {
        "telemetry usage analytics data collection 分析 数据 收集"
    }
    ...
    fn render(
        ...
        let description = if is_enterprise {
            warp_i18n::tr("settings-privacy-telemetry-description-old")
        } else {
            warp_i18n::tr("settings-privacy-telemetry-description")
        };
        ...
        let zdr_label_component = if self.should_show_zdr_badge(app) {
            Flex::row()
                ...
                .with_child(render_body_item_label::<PrivacyPageAction>(
                    warp_i18n::tr("settings-privacy-telemetry-title"),
                    None,
                    None,
        ...
        let switch = if is_toggleable {
            ...
            switch
                .with_tooltip(TooltipConfig {
                    text: warp_i18n::tr("settings-privacy-managed-by-organization"),
        ...
        if !is_on_paid_plan {
            column.add_child(
                ui_builder
                    .paragraph(warp_i18n::tr("settings-privacy-telemetry-free-tier-note"))
                    .with_style(UiComponentStyles {
                        font_color: Some(description_text_color),
                        margin: Some(
        ...
        column.add_child(
            Align::new(
                ui_builder
                    .link(
                        warp_i18n::tr("settings-privacy-telemetry-read-more"),
...
impl SettingsWidget for CrashReportsWidget {
    ...
    fn search_terms(&self) -> &str {
        "telemetry crash reports stability data collection 崩溃 报告 稳定性"
    }
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::tr("settings-privacy-crash-reports-title"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(warp_i18n::tr("settings-privacy-crash-reports-description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
...
impl SettingsWidget for CloudConversationStorageWidget {
    ...
    fn search_terms(&self) -> &str {
        "sync cloud conversation store storage ai agent 云端 对话 存储"
    }
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::tr("settings-privacy-cloud-conversations-title"),
                None,
                LocalOnlyIconState::Hidden,
                toggle_state,
                appearance,
            ...
            .with_child(
                ui_builder
                    .paragraph(if is_checked {
                        warp_i18n::tr("settings-privacy-cloud-conversations-enabled-description")
                    } else {
                        warp_i18n::tr("settings-privacy-cloud-conversations-disabled-description")
                    })
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
...
impl SettingsWidget for NetworkLogWidget {
    ...
    fn search_terms(&self) -> &str {
        "network log audit console data collection 网络 日志 控制台"
    }
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::tr("settings-privacy-network-log-title"),
                None,
            ...
            .with_child(
                ui_builder
                    .paragraph(warp_i18n::tr("settings-privacy-network-log-description"))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
                                .theme()
            ...
            .with_child(
                Align::new(
                    ui_builder
                        .link(
                            warp_i18n::tr("settings-privacy-network-log-view"),
                            None,
                            Some(Box::new(|ctx| {
...
impl SettingsWidget for DataManagementWidget {
    ...
    fn search_terms(&self) -> &str {
        "data management delete account 数据 管理 删除 账户"
    }
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::tr("settings-privacy-data-management-title"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                ui_builder
                    .paragraph(warp_i18n::tr(
                        "settings-privacy-data-management-description",
                    ))
                    .with_style(UiComponentStyles {
                        font_color: Some(
                            appearance
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            warp_i18n::tr("settings-privacy-data-management-link"),
                            None,
                            Some(Box::new(|ctx| {
                                ctx.dispatch_typed_action(
                                    PrivacyPageAction::OpenDataManagementWebpage,
...
impl SettingsWidget for PrivacyPolicyWidget {
    ...
    fn render(
        ...
        Flex::column()
            .with_child(render_body_item::<PrivacyPageAction>(
                warp_i18n::tr("settings-privacy-policy-title"),
                None,
                // Not rendering a setting, so no need to show local only icon state.
                LocalOnlyIconState::Hidden,
                ToggleState::Enabled,
            ...
            .with_child(
                Align::new(
                    appearance
                        .ui_builder()
                        .link(
                            warp_i18n::tr("settings-privacy-policy-link"),
